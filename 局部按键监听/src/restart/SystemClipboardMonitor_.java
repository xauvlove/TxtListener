 ...
 * 
 */  
public class SystemClipboardMonitor_ implements ClipboardOwner{  
    private Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();  
    public static JFrame frame;
    public static Thread t;
    public SystemClipboardMonitor_(){  
    ...
    public static void main(String[] args) {  
        SystemClipboardMonitor_ temp = new SystemClipboardMonitor_();  
        frame = new JFrame();
